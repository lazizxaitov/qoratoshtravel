...
export const content = {
  ru: {
    ...
    search: {
      ...
      destinationPlaceholder: "Все направления",
      peopleLabel: "Персон",
      peopleValue: "Все",
      peopleUnit: "чел.",
  ...
  uz: {
    ...
    search: {
      ...
      destinationPlaceholder: "Barcha yo'nalishlar",
      peopleLabel: "Mehmonlar",
      peopleValue: "Barchasi",
      peopleUnit: "kishi",
      adultsLabel: "Miqdor",
      startLabel: "Kirish",
      endLabel: "Chiqish",
      dateLabel: "Sana",
      dateValue: "Tanlanmagan",
      typeLabel: "Tur",
      typeValue: "Barchasi",
      typeOptions: [
  ...
  en: {
    ...
    search: {
      ...
      destinationPlaceholder: "All destinations",
      peopleLabel: "Guests",
      peopleValue: "All",
      peopleUnit: "people",
